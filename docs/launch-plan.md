...
| 8c | ENGINES-VALUE-2 | 🔲 Task Intake propuesto, pendiente aprobación | — | 2026-07-19 | Fuentes citadas por motor en la página Citations: atribución de cada cita a su motor (Gemini/ChatGPT), chips por dominio, desglose KPI y priorización de oportunidades por nº de motores que citan el dominio. Cero llamadas nuevas, cero esquema. Spec: `docs/specs/engines-value-2.md` |
