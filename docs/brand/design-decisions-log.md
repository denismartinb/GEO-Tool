...
## 85. Auditoría web deja de ser una pantalla que nadie puede demostrar (PRELAUNCH-HARDENING-1, 2026-08-14)
...
tipos generados de Supabase; `.claude/rules/web-audit.md`.
