...
| C5 | ✅ **Hecho (2026-08-13)** — `/blog/que-es-una-auditoria-geo`. Publica los pesos reales de `page-checks.ts` (15/15/15/15/20/20) con sus umbrales, un checklist de 13 puntos ejecutable a mano sobre el código fuente, y declara dónde acaba una auditoría técnica. Detalle: `docs/content-calendar.md`, log §68 | 5 | B/playbooks |
