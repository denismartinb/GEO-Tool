...
| C7 | ✅ **Hecho (2026-08-15)** — `/blog/como-aparecer-en-perplexity` (PR #400). Trata Perplexity como tema de mercado, no como feature: declara con `Verdict` que Genscore no lo mide hoy y **sin comprometer fecha**, tras un Task Intake que midió lo que costaría de verdad (tres áreas de la lista Forbidden a la vez) | 7 | B/playbooks |
...
| C9 | ✅ **Hecho (2026-08-15)** — `/blog/como-hacer-que-chatgpt-recomiende-tu-negocio`. Abre la cola sectorial local. El eje va contra el instinto: para una pyme **el trabajo casi no está en su web**. En resultados locales en general la web propia es el 58 % de las fuentes citadas y los directorios el 15 %, pero en consultas subjetivas —las de recomendación, que son las que preceden a una compra— los directorios saltan al 46 %; las consultas que más importan son aquellas en las que la web menos pesa. Con el techo dicho antes de que lo venda otro: OpenAI no publica cómo elige, y nadie puede garantizar una recomendación. Test que persigue esa ausencia. Detalle: `docs/content-calendar.md`, log §88 | 4 | B/playbooks |
