...
checker, sin aprobar, requiere su propio Task Intake) y Fase A (autoridad/
off-site — Reddit, YouTube, directorios, EUIPO), que es trabajo del fundador
con material que los agentes preparan.
