...
| Slice | Estado |
|---|---|
| **E1 — Una sola grafía** | ✅ **Hecho (2026-08-13)** — 179 `Genscore` y 53 `GeoScore` unificados en copy de usuario. URLs, slugs, dominio e identificadores intactos a propósito. Guardián en `lib/brand/naming.test.ts`. Detalle: log §88 |
