...
**Deployment:** https://geo-tool-gd757nmjm-9v7mrc44g8-1223s-projects.vercel.app (commit `5dc24f4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-467` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
