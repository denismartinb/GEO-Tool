...
**Deployment:** https://geo-tool-1y84c6h9t-9v7mrc44g8-1223s-projects.vercel.app (commit `ba455bf`)
...
- Agentes: `git fetch origin pilot-evidence/pr-418` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
