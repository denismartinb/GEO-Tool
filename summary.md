...
**Deployment:** https://geo-tool-h8yx5whd8-9v7mrc44g8-1223s-projects.vercel.app (commit `dfd62ad`)
...
- Agentes: `git fetch origin pilot-evidence/pr-365` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
