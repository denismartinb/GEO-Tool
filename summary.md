...
**Deployment:** https://geo-tool-cypse2xwv-9v7mrc44g8-1223s-projects.vercel.app (commit `d41fa78`)
...
- Agentes: `git fetch origin pilot-evidence/pr-502` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
