...
**Deployment:** https://geo-tool-avzmxcqzi-9v7mrc44g8-1223s-projects.vercel.app (commit `5951765`)
...
- Agentes: `git fetch origin pilot-evidence/pr-318` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
