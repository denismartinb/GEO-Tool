...
**Deployment:** https://geo-tool-fmyfpmx38-9v7mrc44g8-1223s-projects.vercel.app (commit `4a388e5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-388` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
