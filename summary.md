...
**Deployment:** https://geo-tool-6w0ehcuer-9v7mrc44g8-1223s-projects.vercel.app (commit `bcdf992`)
...
- Agentes: `git fetch origin pilot-evidence/pr-503` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
