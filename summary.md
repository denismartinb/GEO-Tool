...
**Deployment:** https://geo-tool-ph7fdy6qf-9v7mrc44g8-1223s-projects.vercel.app (commit `03420bd`)
...
- Agentes: `git fetch origin pilot-evidence/pr-450` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
