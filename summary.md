...
**Deployment:** https://geo-tool-27d6i978v-9v7mrc44g8-1223s-projects.vercel.app (commit `4bada35`)
...
- Agentes: `git fetch origin pilot-evidence/pr-371` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
