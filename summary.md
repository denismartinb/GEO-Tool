...
**Deployment:** https://geo-tool-75suu38me-9v7mrc44g8-1223s-projects.vercel.app (commit `755d350`)
...
- Agentes: `git fetch origin pilot-evidence/pr-333` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
