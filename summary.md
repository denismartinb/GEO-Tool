...
**Deployment:** https://geo-tool-m9n9vaej1-9v7mrc44g8-1223s-projects.vercel.app (commit `6d53e85`)
...
- Agentes: `git fetch origin pilot-evidence/pr-314` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
