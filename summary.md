...
**Deployment:** https://geo-tool-nmhnb1d6q-9v7mrc44g8-1223s-projects.vercel.app (commit `3fec41a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-416` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
