...
**Deployment:** https://geo-tool-9fxqw5spa-9v7mrc44g8-1223s-projects.vercel.app (commit `2d2976d`)
...
- Agentes: `git fetch origin pilot-evidence/pr-355` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
