...
**Deployment:** https://geo-tool-h4cgoams0-9v7mrc44g8-1223s-projects.vercel.app (commit `d4a6657`)
...
- Agentes: `git fetch origin pilot-evidence/pr-398` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
