...
**Deployment:** https://geo-tool-6z4tdlvhd-9v7mrc44g8-1223s-projects.vercel.app (commit `1651dc4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-497` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
