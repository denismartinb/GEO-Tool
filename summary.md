...
**Deployment:** https://geo-tool-6k0xts7at-9v7mrc44g8-1223s-projects.vercel.app (commit `84eb8f1`)
...
- Agentes: `git fetch origin pilot-evidence/pr-477` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
