...
**Deployment:** https://geo-tool-posneeis9-9v7mrc44g8-1223s-projects.vercel.app (commit `94f4063`)
...
- Agentes: `git fetch origin pilot-evidence/pr-295` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
