...
**Deployment:** https://geo-tool-73twc7wn9-9v7mrc44g8-1223s-projects.vercel.app (commit `8de7a2b`)
...
- Agentes: `git fetch origin pilot-evidence/pr-439` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
