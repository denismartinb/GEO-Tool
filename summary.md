...
**Deployment:** https://geo-tool-al92tm66z-9v7mrc44g8-1223s-projects.vercel.app (commit `b7d6213`)
...
- Agentes: `git fetch origin pilot-evidence/pr-413` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
