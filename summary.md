...
**Deployment:** https://geo-tool-jal4sh0mn-9v7mrc44g8-1223s-projects.vercel.app (commit `11b48df`)
...
- Agentes: `git fetch origin pilot-evidence/pr-400` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
