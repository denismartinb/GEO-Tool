...
**Deployment:** https://geo-tool-h96rq3o9i-9v7mrc44g8-1223s-projects.vercel.app (commit `1a75b10`)
...
- Agentes: `git fetch origin pilot-evidence/pr-469` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
