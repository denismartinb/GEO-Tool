...
**Deployment:** https://geo-tool-b7d2lad0n-9v7mrc44g8-1223s-projects.vercel.app (commit `b3fba74`)
...
- Agentes: `git fetch origin pilot-evidence/pr-356` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
