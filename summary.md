...
**Deployment:** https://geo-tool-3gm2ku1ab-9v7mrc44g8-1223s-projects.vercel.app (commit `2330e01`)
...
- Agentes: `git fetch origin pilot-evidence/pr-424` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
