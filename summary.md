...
**Deployment:** https://geo-tool-im1ajosfb-9v7mrc44g8-1223s-projects.vercel.app (commit `7d60d1c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-421` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
