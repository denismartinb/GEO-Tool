...
**Deployment:** https://geo-tool-36ud8lydm-9v7mrc44g8-1223s-projects.vercel.app (commit `71fa325`)
...
- Agentes: `git fetch origin pilot-evidence/pr-446` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
