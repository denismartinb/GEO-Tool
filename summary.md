...
**Deployment:** https://geo-tool-bpenzmaji-9v7mrc44g8-1223s-projects.vercel.app (commit `a9c051a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-354` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
