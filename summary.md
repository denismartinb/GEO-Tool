...
**Deployment:** https://geo-tool-maso9540f-9v7mrc44g8-1223s-projects.vercel.app (commit `6443e62`)
...
- Agentes: `git fetch origin pilot-evidence/pr-336` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
