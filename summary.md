...
**Deployment:** https://geo-tool-oct5v9sjb-9v7mrc44g8-1223s-projects.vercel.app (commit `06b15aa`)
...
- Agentes: `git fetch origin pilot-evidence/pr-483` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
