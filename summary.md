...
**Deployment:** https://geo-tool-7bpc7mhrg-9v7mrc44g8-1223s-projects.vercel.app (commit `7a12b61`)
...
- Agentes: `git fetch origin pilot-evidence/pr-334` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
