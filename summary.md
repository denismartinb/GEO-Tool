...
**Deployment:** https://geo-tool-6ys062j23-9v7mrc44g8-1223s-projects.vercel.app (commit `c3023a8`)
...
- Agentes: `git fetch origin pilot-evidence/pr-425` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
