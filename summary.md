...
**Deployment:** https://geo-tool-ps8366vei-9v7mrc44g8-1223s-projects.vercel.app (commit `73d34f1`)
...
- Agentes: `git fetch origin pilot-evidence/pr-351` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
