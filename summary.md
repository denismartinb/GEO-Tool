...
**Deployment:** https://geo-tool-bp5s12hri-9v7mrc44g8-1223s-projects.vercel.app (commit `f960b63`)
...
- Agentes: `git fetch origin pilot-evidence/pr-375` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
