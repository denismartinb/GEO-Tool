...
**Deployment:** https://geo-tool-el8kxz2wx-9v7mrc44g8-1223s-projects.vercel.app (commit `0ada1d1`)
...
- Agentes: `git fetch origin pilot-evidence/pr-291` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
