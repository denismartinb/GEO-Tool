...
**Deployment:** https://geo-tool-nww8t91xx-9v7mrc44g8-1223s-projects.vercel.app (commit `a612b90`)
...
- Agentes: `git fetch origin pilot-evidence/pr-456` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
