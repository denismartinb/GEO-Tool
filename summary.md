...
**Deployment:** https://geo-tool-f5zcofeiy-9v7mrc44g8-1223s-projects.vercel.app (commit `d5a9067`)
...
- Agentes: `git fetch origin pilot-evidence/pr-304` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
