...
**Deployment:** https://geo-tool-npuyldomz-9v7mrc44g8-1223s-projects.vercel.app (commit `f10583a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-349` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
