...
**Deployment:** https://geo-tool-khaedil36-9v7mrc44g8-1223s-projects.vercel.app (commit `66e093d`)
...
- Agentes: `git fetch origin pilot-evidence/pr-420` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
