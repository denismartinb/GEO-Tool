...
**Deployment:** https://geo-tool-oflldrxvp-9v7mrc44g8-1223s-projects.vercel.app (commit `41057d8`)
...
- Agentes: `git fetch origin pilot-evidence/pr-454` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
