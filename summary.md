...
**Deployment:** https://geo-tool-xbzpzaqru-9v7mrc44g8-1223s-projects.vercel.app (commit `62ff9d9`)
...
- Agentes: `git fetch origin pilot-evidence/pr-362` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
