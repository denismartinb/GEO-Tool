...
**Deployment:** https://geo-tool-6b0hthpvi-9v7mrc44g8-1223s-projects.vercel.app (commit `702c43a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-479` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
