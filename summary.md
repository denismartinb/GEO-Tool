...
**Deployment:** https://geo-tool-e8hnp4olv-9v7mrc44g8-1223s-projects.vercel.app (commit `db86e2b`)
...
- Agentes: `git fetch origin pilot-evidence/pr-307` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
