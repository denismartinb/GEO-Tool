...
**Deployment:** https://geo-tool-g310n76h5-9v7mrc44g8-1223s-projects.vercel.app (commit `98167ca`)
...
- Agentes: `git fetch origin pilot-evidence/pr-461` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
