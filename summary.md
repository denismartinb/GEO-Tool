...
**Deployment:** https://geo-tool-oe9y2zl9k-9v7mrc44g8-1223s-projects.vercel.app (commit `ee5fa4b`)
...
- Agentes: `git fetch origin pilot-evidence/pr-322` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
