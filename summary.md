...
**Deployment:** https://geo-tool-izhk51ez8-9v7mrc44g8-1223s-projects.vercel.app (commit `9739319`)
...
- Agentes: `git fetch origin pilot-evidence/pr-306` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
