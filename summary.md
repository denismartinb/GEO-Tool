...
**Deployment:** https://geo-tool-dagtjebh5-9v7mrc44g8-1223s-projects.vercel.app (commit `5251ee5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-390` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
