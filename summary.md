...
**Deployment:** https://geo-tool-d3euklxac-9v7mrc44g8-1223s-projects.vercel.app (commit `6acc198`)
...
- Agentes: `git fetch origin pilot-evidence/pr-384` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
