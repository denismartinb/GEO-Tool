...
**Deployment:** https://geo-tool-9fs5hlcvf-9v7mrc44g8-1223s-projects.vercel.app (commit `24c4884`)
...
- Agentes: `git fetch origin pilot-evidence/pr-478` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
