...
**Deployment:** https://geo-tool-8hvt6l85r-9v7mrc44g8-1223s-projects.vercel.app (commit `54c80a8`)
...
- Agentes: `git fetch origin pilot-evidence/pr-468` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
