...
**Deployment:** https://geo-tool-cp0q6t87y-9v7mrc44g8-1223s-projects.vercel.app (commit `a5b64c5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-344` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
