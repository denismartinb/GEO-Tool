...
**Deployment:** https://geo-tool-z4rlx1b9i-9v7mrc44g8-1223s-projects.vercel.app (commit `3a8f0d2`)
...
- Agentes: `git fetch origin pilot-evidence/pr-321` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
