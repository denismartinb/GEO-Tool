...
**Deployment:** https://geo-tool-gznl7ybn4-9v7mrc44g8-1223s-projects.vercel.app (commit `268b9fd`)
...
- Agentes: `git fetch origin pilot-evidence/pr-369` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
