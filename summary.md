...
**Deployment:** https://geo-tool-crfkxa5yz-9v7mrc44g8-1223s-projects.vercel.app (commit `aab86c0`)
...
- Agentes: `git fetch origin pilot-evidence/pr-493` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
