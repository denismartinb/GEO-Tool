...
**Deployment:** https://geo-tool-aoybbq9gu-9v7mrc44g8-1223s-projects.vercel.app (commit `b600234`)
...
- Agentes: `git fetch origin pilot-evidence/pr-323` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
