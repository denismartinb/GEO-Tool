...
**Deployment:** https://geo-tool-9l37de2wj-9v7mrc44g8-1223s-projects.vercel.app (commit `5b7ed15`)
...
- Agentes: `git fetch origin pilot-evidence/pr-358` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
