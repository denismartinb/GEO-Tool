...
**Deployment:** https://geo-tool-ssr8hgxe3-9v7mrc44g8-1223s-projects.vercel.app (commit `80d0677`)
...
- Agentes: `git fetch origin pilot-evidence/pr-376` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
