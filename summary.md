...
**Deployment:** https://geo-tool-5nvb77s97-9v7mrc44g8-1223s-projects.vercel.app (commit `448c86b`)
...
- Agentes: `git fetch origin pilot-evidence/pr-329` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
