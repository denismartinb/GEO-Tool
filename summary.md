...
**Deployment:** https://geo-tool-39rkcvc60-9v7mrc44g8-1223s-projects.vercel.app (commit `38302e8`)
...
- Agentes: `git fetch origin pilot-evidence/pr-437` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
