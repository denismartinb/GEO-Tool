...
**Deployment:** https://geo-tool-4l5ta8d3h-9v7mrc44g8-1223s-projects.vercel.app (commit `ee99aa4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-487` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
