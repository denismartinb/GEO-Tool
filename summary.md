...
**Deployment:** https://geo-tool-6l9zuvp9a-9v7mrc44g8-1223s-projects.vercel.app (commit `a69f873`)
...
- Agentes: `git fetch origin pilot-evidence/pr-385` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
