...
**Deployment:** https://geo-tool-kdonx8v95-9v7mrc44g8-1223s-projects.vercel.app (commit `2f7e8b5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-508` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
