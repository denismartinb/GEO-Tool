...
**Deployment:** https://geo-tool-dsjwpxhlo-9v7mrc44g8-1223s-projects.vercel.app (commit `e4c18d8`)
...
- Agentes: `git fetch origin pilot-evidence/pr-415` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
