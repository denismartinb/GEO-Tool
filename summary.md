...
**Deployment:** https://geo-tool-e41q65wal-9v7mrc44g8-1223s-projects.vercel.app (commit `2103aa5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-403` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
