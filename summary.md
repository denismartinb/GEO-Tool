...
**Deployment:** https://geo-tool-8vgeeuyge-9v7mrc44g8-1223s-projects.vercel.app (commit `7afbdde`)
...
- Agentes: `git fetch origin pilot-evidence/pr-482` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
