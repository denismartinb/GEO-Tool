...
**Deployment:** https://geo-tool-qidvbvp9e-9v7mrc44g8-1223s-projects.vercel.app (commit `76c2b50`)
...
- Agentes: `git fetch origin pilot-evidence/pr-494` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
