...
**Deployment:** https://geo-tool-ozbkp39sn-9v7mrc44g8-1223s-projects.vercel.app (commit `142ee0e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-481` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
