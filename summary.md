...
**Deployment:** https://geo-tool-lfjnbjb82-9v7mrc44g8-1223s-projects.vercel.app (commit `78471ed`)
...
- Agentes: `git fetch origin pilot-evidence/pr-408` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
