...
**Deployment:** https://geo-tool-r1yes5r4d-9v7mrc44g8-1223s-projects.vercel.app (commit `da48c73`)
...
| recs-interactions | ⚠️ no ejecutado | ✅ | ✅ |
...
- Agentes: `git fetch origin pilot-evidence/pr-452` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
