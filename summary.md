...
**Deployment:** https://geo-tool-ffk1vynz6-9v7mrc44g8-1223s-projects.vercel.app (commit `d2a942b`)
...
- Agentes: `git fetch origin pilot-evidence/pr-370` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
