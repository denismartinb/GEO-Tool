...
**Deployment:** https://geo-tool-fui1dp43f-9v7mrc44g8-1223s-projects.vercel.app (commit `a0445a0`)
...
- Agentes: `git fetch origin pilot-evidence/pr-436` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
