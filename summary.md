...
**Deployment:** https://geo-tool-cl1gmp7bq-9v7mrc44g8-1223s-projects.vercel.app (commit `1f821c5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-399` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
