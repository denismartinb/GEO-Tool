...
**Deployment:** https://geo-tool-mleyy2enl-9v7mrc44g8-1223s-projects.vercel.app (commit `d158212`)
...
- Agentes: `git fetch origin pilot-evidence/pr-414` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
