...
**Deployment:** https://geo-tool-n0kw7diqa-9v7mrc44g8-1223s-projects.vercel.app (commit `315748d`)
...
- Agentes: `git fetch origin pilot-evidence/pr-496` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
