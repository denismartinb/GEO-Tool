...
**Deployment:** https://geo-tool-njx44dpoh-9v7mrc44g8-1223s-projects.vercel.app (commit `c0e6737`)
...
- Agentes: `git fetch origin pilot-evidence/pr-431` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
