...
**Deployment:** https://geo-tool-r932uic9y-9v7mrc44g8-1223s-projects.vercel.app (commit `15bfc42`)
...
- Agentes: `git fetch origin pilot-evidence/pr-410` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
