...
**Deployment:** https://geo-tool-22fpvt318-9v7mrc44g8-1223s-projects.vercel.app (commit `4a03df0`)
...
- Agentes: `git fetch origin pilot-evidence/pr-444` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
