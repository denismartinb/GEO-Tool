...
**Deployment:** https://geo-tool-r0f4ew0uk-9v7mrc44g8-1223s-projects.vercel.app (commit `c02fc59`)
...
- Agentes: `git fetch origin pilot-evidence/pr-363` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
