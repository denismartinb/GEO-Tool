...
**Deployment:** https://geo-tool-mm11d89iq-9v7mrc44g8-1223s-projects.vercel.app (commit `c428212`)
...
- Agentes: `git fetch origin pilot-evidence/pr-313` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
