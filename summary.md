...
**Deployment:** https://geo-tool-ehw0jjoj5-9v7mrc44g8-1223s-projects.vercel.app (commit `0e40ba3`)
...
- Agentes: `git fetch origin pilot-evidence/pr-368` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
