...
**Deployment:** https://geo-tool-5uyfz4fd6-9v7mrc44g8-1223s-projects.vercel.app (commit `2e37003`)
...
- Agentes: `git fetch origin pilot-evidence/pr-441` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
