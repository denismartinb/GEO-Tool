...
**Deployment:** https://geo-tool-7gzk5eihg-9v7mrc44g8-1223s-projects.vercel.app (commit `897760e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-357` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
