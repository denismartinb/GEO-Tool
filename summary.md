...
**Deployment:** https://geo-tool-j9j0fmizm-9v7mrc44g8-1223s-projects.vercel.app (commit `f29c8dd`)
...
- Agentes: `git fetch origin pilot-evidence/pr-402` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
