...
**Deployment:** https://geo-tool-6v0o6r8t2-9v7mrc44g8-1223s-projects.vercel.app (commit `a57a489`)
...
- Agentes: `git fetch origin pilot-evidence/pr-389` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
