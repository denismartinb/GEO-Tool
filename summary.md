...
**Deployment:** https://geo-tool-oik11izyi-9v7mrc44g8-1223s-projects.vercel.app (commit `0a13e64`)
...
- Agentes: `git fetch origin pilot-evidence/pr-387` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
