...
**Deployment:** https://geo-tool-epv03r82f-9v7mrc44g8-1223s-projects.vercel.app (commit `e85cff7`)
...
- Agentes: `git fetch origin pilot-evidence/pr-361` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
