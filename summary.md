...
**Deployment:** https://geo-tool-5hx5om9bi-9v7mrc44g8-1223s-projects.vercel.app (commit `1fe7005`)
...
- Agentes: `git fetch origin pilot-evidence/pr-509` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
