...
**Deployment:** https://geo-tool-c3ya6zvrk-9v7mrc44g8-1223s-projects.vercel.app (commit `394ff59`)
...
- Agentes: `git fetch origin pilot-evidence/pr-367` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
