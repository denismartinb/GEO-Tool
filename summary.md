...
**Deployment:** https://geo-tool-i0dcnbjgf-9v7mrc44g8-1223s-projects.vercel.app (commit `5c5beb4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-422` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
