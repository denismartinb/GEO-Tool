...
**Deployment:** https://geo-tool-91ljb5x76-9v7mrc44g8-1223s-projects.vercel.app (commit `33f9c2f`)
...
- Agentes: `git fetch origin pilot-evidence/pr-460` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
