...
**Deployment:** https://geo-tool-bxerx9cg7-9v7mrc44g8-1223s-projects.vercel.app (commit `2eb9c7c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-486` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
