...
**Deployment:** https://geo-tool-71slbrro1-9v7mrc44g8-1223s-projects.vercel.app (commit `30eb86a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-438` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
