...
**Deployment:** https://geo-tool-mxronoiz1-9v7mrc44g8-1223s-projects.vercel.app (commit `1c3fa23`)
...
- Agentes: `git fetch origin pilot-evidence/pr-417` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
