...
**Deployment:** https://geo-tool-d6l6g81kt-9v7mrc44g8-1223s-projects.vercel.app (commit `3ffe01e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-289` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
