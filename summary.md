...
**Deployment:** https://geo-tool-j71zbu20r-9v7mrc44g8-1223s-projects.vercel.app (commit `f953770`)
...
- Agentes: `git fetch origin pilot-evidence/pr-488` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
