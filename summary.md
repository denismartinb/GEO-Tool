...
**Deployment:** https://geo-tool-nds99gm0h-9v7mrc44g8-1223s-projects.vercel.app (commit `5c924f7`)
...
- Agentes: `git fetch origin pilot-evidence/pr-407` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
