...
**Deployment:** https://geo-tool-r4u1fqzus-9v7mrc44g8-1223s-projects.vercel.app (commit `7e914b2`)
...
- Agentes: `git fetch origin pilot-evidence/pr-458` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
