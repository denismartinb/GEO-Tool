...
**Deployment:** https://geo-tool-ponglxeu6-9v7mrc44g8-1223s-projects.vercel.app (commit `41e54ff`)
...
- Agentes: `git fetch origin pilot-evidence/pr-339` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
