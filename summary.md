...
**Deployment:** https://geo-tool-ptssyseyg-9v7mrc44g8-1223s-projects.vercel.app (commit `43f078e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-300` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
