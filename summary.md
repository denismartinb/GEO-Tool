...
**Deployment:** https://geo-tool-5rite4j9n-9v7mrc44g8-1223s-projects.vercel.app (commit `0715a01`)
...
- Agentes: `git fetch origin pilot-evidence/pr-462` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
