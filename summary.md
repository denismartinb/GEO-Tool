...
**Deployment:** https://geo-tool-9wfi7vkxy-9v7mrc44g8-1223s-projects.vercel.app (commit `8c6a5a6`)
...
- Agentes: `git fetch origin pilot-evidence/pr-382` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
