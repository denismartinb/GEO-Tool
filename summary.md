...
**Deployment:** https://geo-tool-cd7ojl8cr-9v7mrc44g8-1223s-projects.vercel.app (commit `874bd7d`)
...
- Agentes: `git fetch origin pilot-evidence/pr-412` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
