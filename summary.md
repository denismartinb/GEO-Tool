...
**Deployment:** https://geo-tool-7e07g8or8-9v7mrc44g8-1223s-projects.vercel.app (commit `3853cdb`)
...
- Agentes: `git fetch origin pilot-evidence/pr-504` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
