...
**Deployment:** https://geo-tool-g5t362p66-9v7mrc44g8-1223s-projects.vercel.app (commit `5eb6b61`)
...
- Agentes: `git fetch origin pilot-evidence/pr-447` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
