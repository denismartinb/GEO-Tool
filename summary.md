...
**Deployment:** https://geo-tool-kvt0g7rrx-9v7mrc44g8-1223s-projects.vercel.app (commit `a31f67c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-498` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
