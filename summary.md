...
**Deployment:** https://geo-tool-qurrrbiwy-9v7mrc44g8-1223s-projects.vercel.app (commit `030d6a4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-485` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
