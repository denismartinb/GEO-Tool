...
**Deployment:** https://geo-tool-67xestly5-9v7mrc44g8-1223s-projects.vercel.app (commit `4645021`)
...
- Agentes: `git fetch origin pilot-evidence/pr-393` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
