...
**Deployment:** https://geo-tool-eda420m9b-9v7mrc44g8-1223s-projects.vercel.app (commit `fcc6b42`)
...
- Agentes: `git fetch origin pilot-evidence/pr-348` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
