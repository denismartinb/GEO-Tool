...
**Deployment:** https://geo-tool-ds91qz28k-9v7mrc44g8-1223s-projects.vercel.app (commit `7714c76`)
...
- Agentes: `git fetch origin pilot-evidence/pr-341` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
