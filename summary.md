...
**Deployment:** https://geo-tool-jcdwov9go-9v7mrc44g8-1223s-projects.vercel.app (commit `4f4ccca`)
...
- Agentes: `git fetch origin pilot-evidence/pr-501` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
