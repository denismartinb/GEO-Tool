...
**Deployment:** https://geo-tool-m9fzivotn-9v7mrc44g8-1223s-projects.vercel.app (commit `ee8248a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-377` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
