...
**Deployment:** https://geo-tool-fbvpa5su0-9v7mrc44g8-1223s-projects.vercel.app (commit `239de20`)
...
- Agentes: `git fetch origin pilot-evidence/pr-432` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
