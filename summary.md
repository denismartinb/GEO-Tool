...
**Deployment:** https://geo-tool-oania7nyj-9v7mrc44g8-1223s-projects.vercel.app (commit `23bee2f`)
...
- Agentes: `git fetch origin pilot-evidence/pr-499` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
