...
**Deployment:** https://geo-tool-gln9955f7-9v7mrc44g8-1223s-projects.vercel.app (commit `8d5ca6d`)
...
- Agentes: `git fetch origin pilot-evidence/pr-513` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
