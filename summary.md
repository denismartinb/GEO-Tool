...
**Deployment:** https://geo-tool-ey8ey8p87-9v7mrc44g8-1223s-projects.vercel.app (commit `0ecf02f`)
...
- Agentes: `git fetch origin pilot-evidence/pr-491` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
