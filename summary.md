...
**Deployment:** https://geo-tool-b94qiuyeu-9v7mrc44g8-1223s-projects.vercel.app (commit `fe88836`)
...
- Agentes: `git fetch origin pilot-evidence/pr-373` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
