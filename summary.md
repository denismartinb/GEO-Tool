...
**Deployment:** https://geo-tool-9yostp514-9v7mrc44g8-1223s-projects.vercel.app (commit `783d38e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-463` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
