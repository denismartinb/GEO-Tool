...
**Deployment:** https://geo-tool-9n5ihzdk3-9v7mrc44g8-1223s-projects.vercel.app (commit `5b8e132`)
...
- Agentes: `git fetch origin pilot-evidence/pr-451` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
