...
**Deployment:** https://geo-tool-2upwxuean-9v7mrc44g8-1223s-projects.vercel.app (commit `2b58d48`)
...
- Agentes: `git fetch origin pilot-evidence/pr-309` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
