...
**Deployment:** https://geo-tool-k3raekhu8-9v7mrc44g8-1223s-projects.vercel.app (commit `f29bff4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-434` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
