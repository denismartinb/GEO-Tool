...
**Deployment:** https://geo-tool-phmdn2r2p-9v7mrc44g8-1223s-projects.vercel.app (commit `e545c56`)
...
- Agentes: `git fetch origin pilot-evidence/pr-317` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
