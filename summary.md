...
**Deployment:** https://geo-tool-fshy4jtcz-9v7mrc44g8-1223s-projects.vercel.app (commit `bda3c07`)
...
- Agentes: `git fetch origin pilot-evidence/pr-394` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
