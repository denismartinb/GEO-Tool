...
**Deployment:** https://geo-tool-yd4s5f7to-9v7mrc44g8-1223s-projects.vercel.app (commit `0c8eae0`)
...
- Agentes: `git fetch origin pilot-evidence/pr-507` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
