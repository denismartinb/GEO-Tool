...
**Deployment:** https://geo-tool-70kalqrwb-9v7mrc44g8-1223s-projects.vercel.app (commit `feada8c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-350` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
