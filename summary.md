...
**Deployment:** https://geo-tool-arsacrqqs-9v7mrc44g8-1223s-projects.vercel.app (commit `ff33697`)
...
- Agentes: `git fetch origin pilot-evidence/pr-305` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
