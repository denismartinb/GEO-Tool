...
**Deployment:** https://geo-tool-6dkyo81gn-9v7mrc44g8-1223s-projects.vercel.app (commit `cb68ddd`)
...
- Agentes: `git fetch origin pilot-evidence/pr-515` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
