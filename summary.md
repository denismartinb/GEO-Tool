...
**Deployment:** https://geo-tool-wna9so7x5-9v7mrc44g8-1223s-projects.vercel.app (commit `65c7918`)
...
- Agentes: `git fetch origin pilot-evidence/pr-506` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
