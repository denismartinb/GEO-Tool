...
**Deployment:** https://geo-tool-aolltan6m-9v7mrc44g8-1223s-projects.vercel.app (commit `f979118`)
...
- Agentes: `git fetch origin pilot-evidence/pr-345` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
