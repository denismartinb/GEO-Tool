...
**Deployment:** https://geo-tool-5b0xjvusn-9v7mrc44g8-1223s-projects.vercel.app (commit `6c13de5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-492` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
