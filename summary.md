...
**Deployment:** https://geo-tool-cm6haiiq3-9v7mrc44g8-1223s-projects.vercel.app (commit `7167d68`)
...
- Agentes: `git fetch origin pilot-evidence/pr-435` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
