...
**Deployment:** https://geo-tool-qq89s6jx5-9v7mrc44g8-1223s-projects.vercel.app (commit `4973533`)
...
- Agentes: `git fetch origin pilot-evidence/pr-449` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
