...
**Deployment:** https://geo-tool-l0zhiq8yi-9v7mrc44g8-1223s-projects.vercel.app (commit `a4ff7e3`)
...
- Agentes: `git fetch origin pilot-evidence/pr-428` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
