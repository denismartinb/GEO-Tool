...
**Deployment:** https://geo-tool-b2bkiuc3j-9v7mrc44g8-1223s-projects.vercel.app (commit `644a337`)
...
- Agentes: `git fetch origin pilot-evidence/pr-484` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
