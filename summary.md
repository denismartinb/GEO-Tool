...
**Deployment:** https://geo-tool-pjwcf9prt-9v7mrc44g8-1223s-projects.vercel.app (commit `e0eede7`)
...
- Agentes: `git fetch origin pilot-evidence/pr-386` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
