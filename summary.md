...
**Deployment:** https://geo-tool-4oxm1vqwm-9v7mrc44g8-1223s-projects.vercel.app (commit `ac39160`)
...
- Agentes: `git fetch origin pilot-evidence/pr-316` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
