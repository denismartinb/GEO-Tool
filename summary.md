...
**Deployment:** https://geo-tool-re1b4izu0-9v7mrc44g8-1223s-projects.vercel.app (commit `7a73244`)
...
- Agentes: `git fetch origin pilot-evidence/pr-466` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
