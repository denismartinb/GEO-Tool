...
**Deployment:** https://geo-tool-8gu9sjd6p-9v7mrc44g8-1223s-projects.vercel.app (commit `3085c38`)
...
- Agentes: `git fetch origin pilot-evidence/pr-353` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
