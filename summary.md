...
**Deployment:** https://geo-tool-hu9g70lem-9v7mrc44g8-1223s-projects.vercel.app (commit `3d1e77f`)
...
- Agentes: `git fetch origin pilot-evidence/pr-457` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
