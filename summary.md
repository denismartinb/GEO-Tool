...
**Deployment:** https://geo-tool-a92hle5n1-9v7mrc44g8-1223s-projects.vercel.app (commit `7e34d36`)
...
- Agentes: `git fetch origin pilot-evidence/pr-372` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
