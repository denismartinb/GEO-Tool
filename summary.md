...
**Deployment:** https://geo-tool-cdnuis9kq-9v7mrc44g8-1223s-projects.vercel.app (commit `e3d6ca3`)
...
- Agentes: `git fetch origin pilot-evidence/pr-332` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
