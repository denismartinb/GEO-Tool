...
**Deployment:** https://geo-tool-9nsz7d80o-9v7mrc44g8-1223s-projects.vercel.app (commit `999e51c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-423` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
