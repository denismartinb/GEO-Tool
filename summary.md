...
**Deployment:** https://geo-tool-5w7rwbgdn-9v7mrc44g8-1223s-projects.vercel.app (commit `f7e227c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-366` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
