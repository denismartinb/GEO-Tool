...
**Deployment:** https://geo-tool-ocb9xixrv-9v7mrc44g8-1223s-projects.vercel.app (commit `23ddd9a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-440` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
