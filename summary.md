...
**Deployment:** https://geo-tool-6zn5f23gm-9v7mrc44g8-1223s-projects.vercel.app (commit `26f7440`)
...
- Agentes: `git fetch origin pilot-evidence/pr-442` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
