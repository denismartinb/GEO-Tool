...
**Deployment:** https://geo-tool-c6q71qf5h-9v7mrc44g8-1223s-projects.vercel.app (commit `17e1a2c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-505` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
