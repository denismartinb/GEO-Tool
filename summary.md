...
**Deployment:** https://geo-tool-cc1d9799f-9v7mrc44g8-1223s-projects.vercel.app (commit `0265f40`)
...
- Agentes: `git fetch origin pilot-evidence/pr-347` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
