...
**Deployment:** https://geo-tool-d8hm4krz3-9v7mrc44g8-1223s-projects.vercel.app (commit `bbec03e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-312` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
