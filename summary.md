...
**Deployment:** https://geo-tool-pnjzaj09h-9v7mrc44g8-1223s-projects.vercel.app (commit `65a519a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-445` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
