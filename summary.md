...
**Deployment:** https://geo-tool-efycigl3r-9v7mrc44g8-1223s-projects.vercel.app (commit `0c4bc9a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-297` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
