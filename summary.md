...
**Deployment:** https://geo-tool-hkz20h84o-9v7mrc44g8-1223s-projects.vercel.app (commit `c1d206c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-391` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
