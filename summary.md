...
**Deployment:** https://geo-tool-c0bkymtlu-9v7mrc44g8-1223s-projects.vercel.app (commit `041b781`)
...
- Agentes: `git fetch origin pilot-evidence/pr-330` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
