...
**Deployment:** https://geo-tool-12j3xiwfo-9v7mrc44g8-1223s-projects.vercel.app (commit `f6f76bd`)
...
- Agentes: `git fetch origin pilot-evidence/pr-343` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
