...
**Deployment:** https://geo-tool-km75ely7f-9v7mrc44g8-1223s-projects.vercel.app (commit `6bccc87`)
...
- Agentes: `git fetch origin pilot-evidence/pr-480` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
