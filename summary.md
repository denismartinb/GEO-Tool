...
**Deployment:** https://geo-tool-bvusud4wl-9v7mrc44g8-1223s-projects.vercel.app (commit `63d0d4e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-392` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
