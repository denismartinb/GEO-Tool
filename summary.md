...
**Deployment:** https://geo-tool-emg263e1a-9v7mrc44g8-1223s-projects.vercel.app (commit `ab6f52e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-325` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
