...
**Deployment:** https://geo-tool-3zjohhn2u-9v7mrc44g8-1223s-projects.vercel.app (commit `fd8b16e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-338` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
