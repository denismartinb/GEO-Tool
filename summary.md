...
**Deployment:** https://geo-tool-doqxslbr6-9v7mrc44g8-1223s-projects.vercel.app (commit `e94fad4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-360` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
