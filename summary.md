...
**Deployment:** https://geo-tool-5cezvy79k-9v7mrc44g8-1223s-projects.vercel.app (commit `517f673`)
...
- Agentes: `git fetch origin pilot-evidence/pr-409` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
