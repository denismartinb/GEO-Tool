...
**Deployment:** https://geo-tool-agh7991aw-9v7mrc44g8-1223s-projects.vercel.app (commit `ffbdabb`)
...
- Agentes: `git fetch origin pilot-evidence/pr-378` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
