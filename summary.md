...
**Deployment:** https://geo-tool-2ixgf5agk-9v7mrc44g8-1223s-projects.vercel.app (commit `7db9374`)
...
- Agentes: `git fetch origin pilot-evidence/pr-500` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
