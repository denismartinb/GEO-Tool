...
**Deployment:** https://geo-tool-i5zeguwj9-9v7mrc44g8-1223s-projects.vercel.app (commit `79b1467`)
...
- Agentes: `git fetch origin pilot-evidence/pr-395` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
