...
**Deployment:** https://geo-tool-17dvx9ijg-9v7mrc44g8-1223s-projects.vercel.app (commit `9eba15c`)
...
- Agentes: `git fetch origin pilot-evidence/pr-430` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
