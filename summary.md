...
**Deployment:** https://geo-tool-ivbpzinqp-9v7mrc44g8-1223s-projects.vercel.app (commit `8e7a039`)
...
- Agentes: `git fetch origin pilot-evidence/pr-443` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
