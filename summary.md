...
**Deployment:** https://geo-tool-joguy998g-9v7mrc44g8-1223s-projects.vercel.app (commit `480a2d9`)
...
- Agentes: `git fetch origin pilot-evidence/pr-489` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
