...
**Deployment:** https://geo-tool-q3fljaf0d-9v7mrc44g8-1223s-projects.vercel.app (commit `3979ad5`)
...
- Agentes: `git fetch origin pilot-evidence/pr-337` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
