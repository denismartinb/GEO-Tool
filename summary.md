...
**Deployment:** https://geo-tool-eltb89i7v-9v7mrc44g8-1223s-projects.vercel.app (commit `3976564`)
...
- Agentes: `git fetch origin pilot-evidence/pr-419` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
