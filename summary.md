...
**Deployment:** https://geo-tool-lo8s0yxee-9v7mrc44g8-1223s-projects.vercel.app (commit `4f5384f`)
...
- Agentes: `git fetch origin pilot-evidence/pr-397` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
