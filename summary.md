...
**Deployment:** https://geo-tool-fhvjj86ry-9v7mrc44g8-1223s-projects.vercel.app (commit `8ecfe43`)
...
- Agentes: `git fetch origin pilot-evidence/pr-405` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
