...
**Deployment:** https://geo-tool-oq7masudy-9v7mrc44g8-1223s-projects.vercel.app (commit `ab3e930`)
...
- Agentes: `git fetch origin pilot-evidence/pr-427` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
