...
**Deployment:** https://geo-tool-g62t36i0w-9v7mrc44g8-1223s-projects.vercel.app (commit `d51d285`)
...
- Agentes: `git fetch origin pilot-evidence/pr-510` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
