...
**Deployment:** https://geo-tool-a59wnrdbr-9v7mrc44g8-1223s-projects.vercel.app (commit `bf5e034`)
...
- Agentes: `git fetch origin pilot-evidence/pr-352` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
