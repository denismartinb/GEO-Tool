...
**Deployment:** https://geo-tool-p1e61kipf-9v7mrc44g8-1223s-projects.vercel.app (commit `6b774cb`)
...
- Agentes: `git fetch origin pilot-evidence/pr-310` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
