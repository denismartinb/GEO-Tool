...
**Deployment:** https://geo-tool-8fa9yb8rz-9v7mrc44g8-1223s-projects.vercel.app (commit `39d038e`)
...
- Agentes: `git fetch origin pilot-evidence/pr-292` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
