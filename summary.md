...
**Deployment:** https://geo-tool-co1nm6anb-9v7mrc44g8-1223s-projects.vercel.app (commit `3e040f7`)
...
- Agentes: `git fetch origin pilot-evidence/pr-379` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
