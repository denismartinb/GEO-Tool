...
**Deployment:** https://geo-tool-nov60rl1u-9v7mrc44g8-1223s-projects.vercel.app (commit `c286058`)
...
- Agentes: `git fetch origin pilot-evidence/pr-294` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
