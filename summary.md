...
**Deployment:** https://geo-tool-8yz886pqd-9v7mrc44g8-1223s-projects.vercel.app (commit `2a4701a`)
...
- Agentes: `git fetch origin pilot-evidence/pr-311` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
