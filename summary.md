...
**Deployment:** https://geo-tool-5hq9atz78-9v7mrc44g8-1223s-projects.vercel.app (commit `fa98f11`)
...
- Agentes: `git fetch origin pilot-evidence/pr-453` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
