...
**Deployment:** https://geo-tool-ou1s313ew-9v7mrc44g8-1223s-projects.vercel.app (commit `3c2ceac`)
...
- Agentes: `git fetch origin pilot-evidence/pr-396` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
