...
**Deployment:** https://geo-tool-6j92pu8nb-9v7mrc44g8-1223s-projects.vercel.app (commit `24e07f4`)
...
- Agentes: `git fetch origin pilot-evidence/pr-433` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
