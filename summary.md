...
**Deployment:** https://geo-tool-kewuz3bav-9v7mrc44g8-1223s-projects.vercel.app (commit `aae88b2`)
...
- Agentes: `git fetch origin pilot-evidence/pr-364` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
