...
**Deployment:** https://geo-tool-3q1a3fsw8-9v7mrc44g8-1223s-projects.vercel.app (commit `a6480a7`)
...
- Agentes: `git fetch origin pilot-evidence/pr-406` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
