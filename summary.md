...
**Deployment:** https://geo-tool-b3xqeelz9-9v7mrc44g8-1223s-projects.vercel.app (commit `d2c3321`)
...
- Agentes: `git fetch origin pilot-evidence/pr-411` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
