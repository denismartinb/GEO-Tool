...
**Deployment:** https://geo-tool-osbvb5agj-9v7mrc44g8-1223s-projects.vercel.app (commit `8430329`)
...
- Agentes: `git fetch origin pilot-evidence/pr-511` — los artefactos de Actions se sirven desde Azure Blob, inalcanzable desde un sandbox de agente; git sí atraviesa el proxy.
