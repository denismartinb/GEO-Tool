...
- Name: journeys/settings.spec.ts >> «Eliminar cuenta» closes the page and is never in the index
- Location: tests/pilot/journeys/settings.spec.ts:129:5

# Error details

```
Error: settings-delete-block @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
Estado de sesión en ese instante: cookies de sesión presentes: sb-hrhugndkecdakzenuwly-auth-token.0 (caduca en 575986 min), sb-hrhugndkecdakzenuwly-auth-token.1 (caduca en 575986 min)
