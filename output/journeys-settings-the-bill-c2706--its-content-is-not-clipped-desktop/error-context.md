...
- Name: journeys/settings.spec.ts >> the billing fold opens, and its content is not clipped
- Location: tests/pilot/journeys/settings.spec.ts:92:5

# Error details

```
Error: settings-folds-closed @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
