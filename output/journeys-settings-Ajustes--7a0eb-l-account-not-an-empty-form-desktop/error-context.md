...
- Name: journeys/settings.spec.ts >> Ajustes shows the real account, not an empty form
- Location: tests/pilot/journeys/settings.spec.ts:38:5

# Error details

```
Error: settings @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
