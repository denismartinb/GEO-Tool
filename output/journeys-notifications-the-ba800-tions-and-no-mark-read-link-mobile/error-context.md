...
- Name: journeys/notifications.spec.ts >> the notifications page shows real notifications and no mark-read link
- Location: tests/pilot/journeys/notifications.spec.ts:103:5

# Error details

```
Error: notifications-page @ mobile: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
Estado de sesión en ese instante: cookies de sesión presentes: sb-hrhugndkecdakzenuwly-auth-token.0 (caduca en 575998 min), sb-hrhugndkecdakzenuwly-auth-token.1 (caduca en 575998 min)
