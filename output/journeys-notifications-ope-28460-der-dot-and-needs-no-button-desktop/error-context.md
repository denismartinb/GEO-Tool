...
- Name: journeys/notifications.spec.ts >> opening the bell clears the header dot and needs no button
- Location: tests/pilot/journeys/notifications.spec.ts:37:5

# Error details

```
Error: notifications-bell @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
