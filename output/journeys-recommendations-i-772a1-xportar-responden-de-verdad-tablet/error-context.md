...
- generic [active] [ref=f4e1]:
  - generic [ref=f4e2]:
    - complementary [ref=f4e3]:
      ...
      - link "Amazon amazon.es" [ref=f4e11] [cursor=pointer]:
        - /url: /dashboard/domains
        - generic [ref=f4e12]:
          - generic [ref=f4e13]: Amazon
          - generic [ref=f4e14]: amazon.es
      - generic [ref=f4e17]:
        ...
        - link "Recomendaciones" [ref=f4e51] [cursor=pointer]:
          - /url: /dashboard/projects/c46597c1-f7f3-4aa6-a436-15ab240e897d/recommendations
      - generic [ref=f4e56]:
        - button "¿Qué es el GEO?" [ref=f4e57] [cursor=pointer]
        - link "DE de5@gmail.com Agencia" [ref=f4e61] [cursor=pointer]:
          - /url: /dashboard/settings
          - generic [ref=f4e62]: DE
          - generic [ref=f4e63]:
            - generic [ref=f4e64]: de5@gmail.com
            - generic [ref=f4e65]: Agencia
    - generic [ref=f4e68]:
      - banner [ref=f4e69]:
        - generic [ref=f4e70]: Completado
        - generic [ref=f4e72]:
          - button "Notificaciones" [ref=f4e74] [cursor=pointer]
          - button "Cerrar sesión" [ref=f4e79] [cursor=pointer]
      - generic [ref=f4e83]:
        - generic [ref=f4e88]: Tu análisis de hoy no se repetirá. Activa el seguimiento diario para ver cómo evoluciona tu visibilidad frente a tus competidores.
        - button "Activar seguimiento diario" [ref=f4e90] [cursor=pointer]
      - main [ref=f4e91]:
        - generic [ref=f4e92]:
          - generic [ref=f4e93]:
            - generic [ref=f4e95]:
              - paragraph [ref=f4e96]: Recomendaciones
              - generic [ref=f4e97]: Amazon
            - generic [ref=f4e99]: Escaneado 21 ago 2026
          - generic [ref=f4e101]:
            - generic [ref=f4e108]:
              - generic [ref=f4e109]: Tu web bloquea a GPTBot y OAI-SearchBot y 3 más
              - generic [ref=f4e110]:
                - text: Esos motores no pueden leer tu contenido, así que no pueden citarte.
                - link "Ver cómo arreglarlo" [ref=f4e111] [cursor=pointer]:
                  - /url: /dashboard/projects/c46597c1-f7f3-4aa6-a436-15ab240e897d/web-audit
            - generic [ref=f4e112]:
              - generic [ref=f4e113]:
                - generic [ref=f4e114]:
                  - text: Presencia
                  - note "En cuántas de tus consultas te nombra la IA. Si no te nombra, no te pueden elegir." [ref=f4e115]:
                    - generic: i
                - generic [ref=f4e116]: "100"
              - generic [ref=f4e119]:
                - generic [ref=f4e120]:
                  - text: Cuota de voz
                  - note "Cuánto espacio ocupas tú frente a tus competidores en el total de menciones." [ref=f4e121]:
                    - generic: i
                - generic [ref=f4e122]: "50"
              - generic [ref=f4e125]:
                - generic [ref=f4e126]:
                  - text: Autoridad
                  - note "Con qué frecuencia la IA usa tu web como fuente y te cita, en vez de citar a otros." [ref=f4e127]:
                    - generic: i
                - generic [ref=f4e128]: "0"
            - generic [ref=f4e130]:
              - generic [ref=f4e131]: Nada que corregir ahora mismo
              - generic [ref=f4e132]: Este escaneo no ha encontrado ningún hueco accionable. Vuelve tras el próximo.
              - link "Ver detalle del escaneo" [ref=f4e133] [cursor=pointer]:
