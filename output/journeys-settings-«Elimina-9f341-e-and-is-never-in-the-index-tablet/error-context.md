...
```
Error: settings-delete-block @ tablet: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
Estado de sesión en ese instante: cookies de sesión presentes: sb-hrhugndkecdakzenuwly-auth-token.0 (caduca en 575991 min), sb-hrhugndkecdakzenuwly-auth-token.1 (caduca en 575991 min)
