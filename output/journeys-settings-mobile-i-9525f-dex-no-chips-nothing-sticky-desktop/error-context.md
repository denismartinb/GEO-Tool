...
- Name: journeys/settings.spec.ts >> mobile is one scroll: no index, no chips, nothing sticky
- Location: tests/pilot/journeys/settings.spec.ts:167:5

# Error details

```
Error: settings-no-section-nav @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
