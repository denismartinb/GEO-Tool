...
- Name: journeys/settings.spec.ts >> the three sections are all present and in order
- Location: tests/pilot/journeys/settings.spec.ts:56:5

# Error details

```
Error: settings-sections @ desktop: session was rejected — landed on https://geo-tool-nsr7w9h1t-9v7mrc44g8-1223s-projects.vercel.app/login
