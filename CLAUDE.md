...
| Prompts | — *(sin regla propia todavía)* | **SCREEN-POLISH-1 Fase A: el sentimiento sólo se cuenta sobre filas con `brand_mentioned === true` (`lib/metrics/brand-sentiment.ts`, dueño único junto con Overview y por-motor), las filas de prompt/tema se pueden abrir con teclado, y "Topics"/"categoría" pasan a "tema" (2026-09-06, log §204)** · ANIMATION-PARITY-1: la misión del primer escaneo se ve y termina igual en las 6 secciones (2026-08-26, log §168) · SCAN-FULLSCREEN-HEADER-1: la cabecera fija se oculta mientras dura la misión del primer escaneo (2026-08-25, log §160) · PROMPT-DRAWER-TRUTH-1 (2026-08-23, log §147) · SAMPLING-SURFACE-1 (2026-08-05) | log §5, §24, §147, §160, §168, §204 · ADR 0021/0030 |
