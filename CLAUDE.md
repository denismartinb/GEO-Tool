...
| Recomendaciones | `recommendations.md` | **PDF-EXPORT-PLAN-1: la portada ocupaba página y media — faltaba `box-sizing: border-box` (la caja medía 1235px, no 1123px); se rehace la paginación entera con `@page` con nombre para el contenido, y el degradado del artboard pasa a PNG incrustado (2026-09-11, log §216)** · PDF-EXPORT-PLAN-1: la portada se deformaba en un dispositivo real (layout de consola con `overflow`/`transform` como ancestro) — el informe se monta por `createPortal` en `document.body`, y el resplandor decorativo pasa de degradado CSS a SVG, más fiable al exportar a PDF (2026-09-11, log §215)** · PDF-EXPORT-PLAN-1 corrección: logo oficial, medidas px pixel-perfect contra el artboard, y `.xrp-content` deja de tener altura fija — una lista larga de recomendaciones se recortaba en silencio en vez de fluir a más páginas (2026-09-11, log §214)** · PDF-EXPORT-PLAN-1: "Exportar plan" deja de descargar un `.md` y pasa a abrir el diálogo de impresión del navegador sobre un informe con marca ("Informe de consultoría", diseño aprobado en `docs/design-reference/pdf-export-plan-1/`) — el `.md` conserva su generador sólo como contenido del modal de respaldo (2026-09-11, log §213)** · ACTIONS-OBSERVABLE-1 slice 4b: "Exportar plan" pasa por el contrato de acción, con modal de respaldo si la descarga falla — la última acción de la Fase 4 que queda como CTA (2026-09-08, log §210; su otra mitad, "Activar seguimiento diario", se retiró horas después en vez de arreglarse, ver zona "Dominios y depuración" §211)** · ACTIONS-OBSERVABLE-1 slice 4a: "generar" y "marcar como hecho" pasan por un contrato de acción compartido; el "Deshacer" de la segunda vive de forma durable en "Resueltas", no en la tarjeta activa (2026-09-07, log §203) · ENTITY-HYGIENE-1: "Seguir competidor emergente" deja de poder recomendar un asistente de IA (2026-08-30, log §200) · La pestaña "Resueltas" tenía el icono de check desalineado del texto — `.rec-main` esperaba un solo hijo tras RECS-REDESIGN-1 (2026-08-29, log §196) · RECURRING-VALUE-1: la tarjeta activa dice "La verás reflejada en tu próximo escaneo" junto a "Marcar como hecho" — primer recorte de Fase 3 de la auditoría externa (2026-08-29, log §195) · RECS-EVIDENCE-2: cada tarjeta dice qué motor la respalda, y dos motores de acuerdo sobre el mismo prompt ya no se pisan entre sí — Fase 7 de la auditoría externa (2026-08-28, log §191) · RECS-LOOP-1 Fase B: la brecha marcada como hecha que reaparece deja de verse como nueva — insignia en la tarjeta activa + veredicto en el historial, mismo ancla fijo que Fase A (2026-08-28, ADR 0041 adenda, log §190) · RECS-LOOP-1 Fase A: la pestaña "Resueltas" verifica si la predicción se cumplió, nunca un delta de score (2026-08-27, ADR 0041, log §181) · AUDIT-RECS-JOIN-1 Fase B (2026-08-27, log §172) · ANIMATION-PARITY-1: la misión del primer escaneo se ve y termina igual en las 6 secciones (2026-08-26, log §168) · AUDIT-RECS-JOIN-1 Fase A (2026-08-22, log §167) · SCAN-FULLSCREEN-HEADER-1: la cabecera fija se oculta mientras dura la misión del primer escaneo (2026-08-25, log §160) · RECS-ACCION-1c (2026-08-21, log §140) · REWRITE-DOMAIN-ANCHOR-1 (2026-08-20/21, log §137, §133 y §134) · RECS-USEFULNESS-1 Fase C: honestidad de lo generado (2026-08-21, log §128) · RECS-ACCION-1a (2026-08-20, log §127) · RECS-USEFULNESS-1 Fase A: integridad del artefacto pegable (2026-08-20, log §126) · RECS-REDESIGN-1 fase 1 (2026-08-17, log §115) · RECS-POTENTIAL-1 (2026-07-23) | log §115, §126, §127, §128, §133, §134, §137, §140, §160, §167, §168, §172, §181, §190, §191, §195, §196, §200, §203, §210, §213, §214, §215, §216 · ADR 0017/0019/0041 · `docs/specs/recommendations/quality-audit-2026-08.md` · `docs/external-audit-2026-08.md` |
