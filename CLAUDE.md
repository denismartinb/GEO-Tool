...
| Navegación pública (pie) | `styles.md` | **FOOTER-PAYMENT-TRUST-1: la fila de pagos seguros llega al pie de las seis pantallas de marketing, compartida con `/precios` en vez de duplicada (2026-08-27, log §182)** | log §46, §182 |
