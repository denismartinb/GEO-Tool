...
| Ajustes de cuenta | — *(sin regla propia todavía)* | **"Datos de empresa" oculto en Cuenta: no tenía consumidor ni plan (2026-08-25, log §165)** · PRELAUNCH-HARDENING-1 Fase R8-a (2026-08-15, log §102) · CONSOLE-REDESIGN-1 Fase A (2026-08-06) | log §38, §102, §165 · `docs/design-reference/console-redesign-1/` |
