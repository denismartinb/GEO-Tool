...
| Recomendaciones | `recommendations.md` | **RECS-LOOP-1 Fase B: la brecha marcada como hecha que reaparece deja de verse como nueva — insignia en la tarjeta activa + veredicto en el historial, mismo ancla fijo que Fase A (2026-08-28, ADR 0041 adenda, log §189)** · RECS-LOOP-1 Fase A: la pestaña "Resueltas" verifica si la predicción se cumplió, nunca un delta de score (2026-08-27, ADR 0041, log §181) · AUDIT-RECS-JOIN-1 Fase B (2026-08-27, log §172) · ANIMATION-PARITY-1: la misión del primer escaneo se ve y termina igual en las 6 secciones (2026-08-26, log §168) · AUDIT-RECS-JOIN-1 Fase A (2026-08-22, log §167) · SCAN-FULLSCREEN-HEADER-1: la cabecera fija se oculta mientras dura la misión del primer escaneo (2026-08-25, log §160) · RECS-ACCION-1c (2026-08-21, log §140) · REWRITE-DOMAIN-ANCHOR-1 (2026-08-20/21, log §137, §133 y §134) · RECS-USEFULNESS-1 Fase C: honestidad de lo generado (2026-08-21, log §128) · RECS-ACCION-1a (2026-08-20, log §127) · RECS-USEFULNESS-1 Fase A: integridad del artefacto pegable (2026-08-20, log §126) · RECS-REDESIGN-1 fase 1 (2026-08-17, log §115) · RECS-POTENTIAL-1 (2026-07-23) | log §115, §126, §127, §128, §133, §134, §137, §140, §160, §167, §168, §172, §181, §189 · ADR 0017/0019/0041 · `docs/specs/recommendations/quality-audit-2026-08.md` |
...
| Páginas citadas | — *(sin regla propia todavía)* | **CITED-DIFF-1 Fase 0: script de validación barata (`pnpm cited-diff:validate`, sólo ejecutable por el fundador) antes de construir la fase permanente — aún sin aprobar (2026-08-28, log §186)** · ANIMATION-PARITY-1: la misión del primer escaneo se ve y termina igual en las 6 secciones (2026-08-26, log §168) · SCAN-FULLSCREEN-HEADER-1: la cabecera fija se oculta mientras dura la misión del primer escaneo (2026-08-25, log §160) · HEADER-FULL-WIDTH-1: la cabecera adopta el patrón compartido de las otras 6 pantallas (2026-08-25, log §151) · Fix: tarjeta de Impacto recortada sin donut (2026-08-17, log §114) · CITATIONS-REDESIGN-1 (2026-08-01) | log §8, §39, §114, §151, §160, §168, §186 · ADR 0010/0012/0013/0023 |
