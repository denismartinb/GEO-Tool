...
| Portada (hero) | `styles.md` | **HOME-2026-08 Fase A: el hero del diseño aprobado y su CTA al comprobador (2026-08-22, log §142)** · HERO-GRADIENT-1: el fondo, un degradado lineal (2026-08-22, log §141) | log §141, §142 · `docs/design-reference/home-2026-08/` · `docs/design-reference/hero-gradient-1/` |
