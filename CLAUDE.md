...
| Recomendaciones | `recommendations.md` | **La pestaña "Resueltas" tenía el icono de check desalineado del texto — `.rec-main` esperaba un solo hijo tras RECS-REDESIGN-1 (2026-08-29, log §196)** · RECS-EVIDENCE-2: cada tarjeta dice qué motor la respalda, y dos motores de acuerdo sobre el mismo prompt ya no se pisan entre sí — Fase 7 de la auditoría externa (2026-08-28, log §191) · RECS-LOOP-1 Fase B: la brecha marcada como hecha que reaparece deja de verse como nueva — insignia en la tarjeta activa + veredicto en el historial, mismo ancla fijo que Fase A (2026-08-28, ADR 0041 adenda, log §190) · RECS-LOOP-1 Fase A: la pestaña "Resueltas" verifica si la predicción se cumplió, nunca un delta de score (2026-08-27, ADR 0041, log §181) · AUDIT-RECS-JOIN-1 Fase B (2026-08-27, log §172) · ANIMATION-PARITY-1: la misión del primer escaneo se ve y termina igual en las 6 secciones (2026-08-26, log §168) · AUDIT-RECS-JOIN-1 Fase A (2026-08-22, log §167) · SCAN-FULLSCREEN-HEADER-1: la cabecera fija se oculta mientras dura la misión del primer escaneo (2026-08-25, log §160) · RECS-ACCION-1c (2026-08-21, log §140) · REWRITE-DOMAIN-ANCHOR-1 (2026-08-20/21, log §137, §133 y §134) · RECS-USEFULNESS-1 Fase C: honestidad de lo generado (2026-08-21, log §128) · RECS-ACCION-1a (2026-08-20, log §127) · RECS-USEFULNESS-1 Fase A: integridad del artefacto pegable (2026-08-20, log §126) · RECS-REDESIGN-1 fase 1 (2026-08-17, log §115) · RECS-POTENTIAL-1 (2026-07-23) | log §115, §126, §127, §128, §133, §134, §137, §140, §160, §167, §168, §172, §181, §190, §191, §196 · ADR 0017/0019/0041 · `docs/specs/recommendations/quality-audit-2026-08.md` · `docs/external-audit-2026-08.md` |
