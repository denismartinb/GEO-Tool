...
<StatGrid label="Comportamiento del comprador de software B2B, según dos estudios de terceros">
  <Stat value="51%" label="Compradores de software B2B que empiezan su investigación en un chatbot de IA más a menudo que en Google. Era el 29% un año antes" source="G2, 2026 Buyer Behavior Report" tone="blue" />
