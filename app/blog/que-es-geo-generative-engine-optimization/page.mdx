...
<Figure
  label="Figura 1."
  caption="La forma de una respuesta generativa: nombra marcas y, cuando las respalda, apunta a una fuente. Texto ilustrativo — no es la respuesta real de ningún motor."
>
  <AnswerSample
    verdict="Respuesta generada por IA"
    text="Para monitorizar la visibilidad de una marca en ChatGPT existen herramientas específicas de GEO, que ejecutan conjuntos de prompts y miden con qué frecuencia aparece cada marca en las respuestas."
    source="tumarca.com/metodologia"
  />
</Figure>
...
<ArticleCta
  title="¿Cómo aparece tu marca en ChatGPT, Gemini o Claude?"
  text="Mídelo con escaneos reales en minutos. Gratis, sin tarjeta."
/>
