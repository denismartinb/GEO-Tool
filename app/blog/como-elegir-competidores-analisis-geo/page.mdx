...
**Dos de las cinco señales** del <a href="/docs/metodologia/geo-score">GEO Score</a> no se pueden calcular sin ella: tu puesto medio **frente a esas marcas**, y qué parte de las menciones totales es tuya. Ninguna de las dos existe en abstracto — las dos se miden contra la lista que tú defines.

<StatGrid label="Lo que la lista de competidores decide">
  <Stat value="2 de 5" label="Señales del GEO Score que se calculan en relación con esta lista" source="Metodología de GenScore" tone="blue" />
  <Stat value="0" label="Veces que tu cuota de voz es comparable con la de otra empresa: cada una se mide sobre su propia lista" source="Metodología de GenScore" tone="cyan" />
  <Stat value="21%" label="Cuota de voz de la marca de ejemplo de la Figura 1 — un resultado, no una regla" source="Datos de ejemplo de este artículo" tone="warm" />
</StatGrid>

Lo que conviene retener: **una parte grande de tu nota se calcula en relación con esta lista, no en absoluto.** No es un ajuste menor de configuración — meter una marca que no compite de verdad contigo hunde tu porcentaje sin que haya pasado nada real en el mercado.
