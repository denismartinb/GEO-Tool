...
<StatGrid>
  <Stat value="25%" label="Prominencia — tu puesto medio frente a ellos" source="ADR-0015 · GEO Score v2" tone="blue" />
  <Stat value="20%" label="Cuota de voz — cuántas menciones son tuyas" source="ADR-0015 · GEO Score v2" tone="cyan" />
  <Stat value="45%" label="Parte de tu GEO Score que depende de con quién te compares" source="ADR-0015 · suma de las dos anteriores" tone="warm" />
</StatGrid>

Esa última cifra es la que conviene tener presente: **casi la mitad de tu <a href="/docs/metodologia/geo-score">GEO Score</a> se calcula en relación con esta lista.** No es un ajuste menor de configuración.
