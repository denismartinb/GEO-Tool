...
<StatGrid label="Lo que decide tu conjunto de prompts">
  <Stat value="2 de 5" label="Señales del GEO Score que se calculan sobre las respuestas a TUS prompts, incluida la que más manda" source="Metodología de GenScore" tone="blue" />
  <Stat value="1" label="Vez que conviene elegir la lista: al principio, y luego dejarla estable" source="Metodología de GenScore" tone="cyan" />
</StatGrid>

La presencia —si la IA te nombra o no— es la señal de más peso del <a href="/docs/metodologia/geo-score">GEO Score</a>, y es también la que más depende de qué preguntes. Cambiar la lista cambia el número, sin que haya cambiado nada en el mercado: por eso conviene elegirla con criterio y luego dejarla estable.
