...
<StatGrid label="Pesos del GEO Score que dependen de tus prompts">
  <Stat value="40%" label="Peso de la presencia — la señal que más depende de qué prompts elijas" source="ADR-0015 · GEO Score v2" tone="blue" />
  <Stat value="25%" label="Peso de la prominencia — tu puesto medio en esas respuestas" source="ADR-0015 · GEO Score v2" tone="cyan" />
</StatGrid>
