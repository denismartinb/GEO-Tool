...
<StatGrid label="Adopción de la IA en la investigación de compra (datos de terceros, 2026)">
  ...
  <Stat value="74%" label="Compradores de 18 a 29 años que han usado IA para investigar una compra, frente al 20% de los mayores de 61" source="Capital One Shopping Research, 2026" tone="cyan" />
...
Estas cifras son de terceros y se refieren al mercado estadounidense. No son datos propios de Genscore ni de tiendas españolas, y no las presentamos como tales. Sirven para dimensionar el fenómeno, no para prometerte un resultado.
